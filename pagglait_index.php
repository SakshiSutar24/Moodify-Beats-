...
<body>
  ...
  <div class="player-container">
    <!-- Album Art -->
    <div class="album-art">
      <img id="albumImage" src="Pagglait-Arijit-Singh.jpg" alt="Album Art">
    </div>
    <!-- Song Info -->
    <div class="song-info">
      <h2 id="songTitle">A Prayer</h2>
      <p id="artist">Arijit Singh</p>
    </div>
    ...
    <div class="bottom-controls">
      <div class="time-container">
        ...
        <span id="totalDuration">-2:30</span>
      </div>
  ...
  <audio id="audioPlayer" src="A-Prayer.mp3"></audio>
  
  <script>
    let songs = [
      { title: "A Prayer", artist: "Arijit Singh", src: "A Prayer - (Raag.Fm).mp3", image: "Pagglait-Arijit-Singh.jpg" },
      { title: "Dil Udd Ja Re Revisited", artist: "Arijit Singh", src: "Dil Udd Ja Re Revisited - (Raag.Fm).mp3", image: "Pagglait-Arijit-Singh.jpg" },
      { title: "Loss Is All That Is Left", artist: "Arijit Singh", src: "Loss Is All That Is Left - (Raag.Fm).mp3", image: "Pagglait-Arijit-Singh.jpg" },
      { title: "Phire Faqeera", artist: "Arijit Singh", src: "Phire Faqeera - (Raag.Fm).mp3", image: "Pagglait-Arijit-Singh.jpg" },
      { title: "Thode Kam Ajnabi Reprise Version", artist: "Arijit Singh", src: "Thode Kam Ajnabi Reprise Version - (Raag.Fm).mp3", image: "Pagglait-Arijit-Singh.jpg" }
    ];
