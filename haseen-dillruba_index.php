...
<body>
  ...
  <div class="content">
    ...
    <div class="player-container">
      <!-- Album Art -->
      <div class="album-art">
        <img id="albumImage" src="haseen-dillruba.jpg" alt="Album Art">
      </div>
      <!-- Song Info -->
      <div class="song-info">
        <h2 id="songTitle">Dil Melt Karda</h2>
        <p id="artist"> Navraj Hans, Nikhita Gandhi</p>
      </div>
    ...
    <audio id="audioPlayer" src="Dil Melt Karda - (Raag.Fm).mp3"></audio>
  </div>
  <script>
    let songs = [
      { title: "Dil Melt Karda", artist: "Navraj Hans", src: "Dil Melt Karda - (Raag.Fm).mp3", image: "haseen-dillruba.jpg" },
      { title: "Lakeeran", artist: "Vikram", src: "Lakeeran - (Raag.Fm).mp3", image: "haseen-dillruba.jpg" },
      { title: "Milaa Yun", artist: "Yashita sharma", src: "Milaa Yun - (Raag.Fm).mp3", image: "haseen-dillruba.jpg" },
      { title: "Phisal Jaa Tu", artist: "Abhijit Shrivastava", src: "Phisal Jaa Tu - (Raag.Fm).mp3", image: "haseen-dillruba.jpg" }
    ];
