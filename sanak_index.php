...
<head>
  ...
  <style>
    ...
    body {
      background: linear-gradient(135deg,rgb(42, 15, 30),rgb(59, 30, 43));
    ...
    .controls button {
      background: linear-gradient(45deg,rgb(246, 59, 168),rgb(235, 37, 162));
      border: none;
      color: #fff;
      width: 40px;
      height: 40px;
    ...
    .controls button:hover {
      transform: scale(1.1);
      box-shadow: 0 0 8px rgba(246, 59, 174, 0.7);
    }
    ...
    .playlist-btn {
      ...
      align-items: center;
      gap: 5px;
      background: linear-gradient(45deg,rgb(246, 59, 193),rgb(241, 19, 178));
      border: none;
      border-radius: 20px;
      color: #fff;
      font-size: 1rem;
    ...
    .home-btn {
      ...
      top: 10px;
      right: 10px;
      background: linear-gradient(45deg,rgb(246, 59, 193),rgb(235, 37, 166));
      border: none;
      color: #fff;
      width: 40px;
      height: 40px;
    ...
    .home-btn:hover {
      transform: scale(1.1);
      box-shadow: 0 0 8px rgba(246, 59, 171, 0.7);
    }
  </style>
</head>
<body>
  ...
  <div class="content">
    ...
    <div class="player-container">
      <!-- Album Art -->
      <div class="album-art">
        <img id="albumImage" src="Sanak.jpg" alt="Album Art">
      </div>
      <!-- Song Info -->
      <div class="song-info">
        <h2 id="songTitle">Aankhein Mili</h2>
        <p id="artist">Stebin Ben</p>
      </div>
    ...
    <audio id="audioPlayer" src="Ankhein Mili - (Raag.Fm).mp3"></audio>
  </div>
  <script>
    let songs = [
      { title: "Aankhein Mili", artist: "Stebin Ben", src: "Ankhein Mili - (Raag.Fm).mp3", image: "Sanak.jpg" },
      { title: "O Yaara Dil Lagana", artist: "Jubin Nautiyal", src: "O Yaara Dil Lagana - (Raag.Fm).mp3", image: "Sanak.jpg" },
      { title: "Suna Hai", artist: "Raj Barman", src: "Suna Hai - (Raag.Fm).mp3", image: "Sanak.jpg" },
      { title: "Suna Hai (Female Version)", artist: "Shreya Ghoshal", src: "Suna Hai Female Version - (Raag.Fm).mp3", image: "Sanak.jpg" }
    ];
