...
<head>
  ...
  <title>Arijit Singh - Moodify Beats</title>
...
<body>
  <div class="container">
    ...
    <div class="left-panel">
      <img src="Arijit-Singh.jpg" alt="Arijit Singh" class="artist-photo">
      <div class="artist-info">
        <h1>Arijit Singh</h1>
        <p class="verified"><i class="bi bi-patch-check-fill"></i> Verified Artist</p>
        
        <p> Singh is an Indian playback singer known for his soulful and melodious voice.</p>
        <p><b>Born:</b> April 25, 1987<p>
  ...
  <script>
    const songs = [
      { name: "Tum Hi Ho", src: "Tum_He_ Ho - (Raag.Fm).mp3" },
      { name: "Tose Naina", src: "Tose_Naina - (Raag.Fm).mp3" },
      { name: "Suno Na Sang Marmar", src: "Suno_Na_Sang_Marmar - (Raag.Fm).mp3" },
      { name: "Raabta", src: "Raabta_Kehdte_Hai_Khuda_Ne - (Raag.Fm).mp3" },
      { name: "Mast Magan", src: "Masat_Magan - (Raag.Fm).mp3" },
      { name: "Love Me Thoda Aur", src: "Love_Me_Thoda_Aur - (Raag.Fm).mp3" },
      { name: "Kabira Encore", src: "Kabir_ Encore - (Raag.Fm).mp3" },
      { name: "Kabhi Jo Badal Barsa", src: "Kabhi_Jo_Badal_Barsa - (Raag.Fm).mp3" },
      { name: "Ilahi", src: "Ilahi - (Raag.Fm).mp3" },
      { name: "Duaa", src: "Duaa - (Raag.Fm).mp3" }
    ];
