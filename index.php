...
<body>
  ...
  <div class="content">
    ...
    <div class="player-container">
      <!-- Album Art -->
      <div class="album-art">
        <img id="albumImage" src="Shiddat-Movie-Manan-Bhardwaj.jpg" alt="Album Art">
      </div>
      <!-- Song Info -->
      <div class="song-info">
        <h2 id="songTitle">Shiddat Reprise</h2>
        <p id="artist">Manan Bhardwaj</p>
      </div>
    ...
    <audio onclick="" id="audioPlayer" src="Shiddat Reprise - (Raag.Fm).mp3"></audio>
  </div>
  <script>
    let songs = [
      { title: "Shiddat Reprise", artist: "Manan Bhardwaj", src: "Shiddat Reprise - (Raag.Fm).mp3", image: "Shiddat-Movie-Manan-Bhardwaj.jpg" },
      { title: "Barbaadiyan", artist: "Sachet-Parampara", src: "Barbaadiyan - (Raag.Fm).mp3", image: "Shiddat-Movie-Manan-Bhardwaj.jpg" },
      { title: "Chitta", artist: "Amit Trivedi", src: "Chitta - (Raag.Fm).mp3", image: "Shiddat-Movie-Manan-Bhardwaj.jpg" },
      { title: "Hum Dum", artist: "Sachet Tandon", src: "Hum Dum - (Raag.Fm).mp3", image: "Shiddat-Movie-Manan-Bhardwaj.jpg" },
      { title: "Jug Jug Jeeve", artist: "Sachin-Jigar", src: "Jug Jug Jeeve - (Raag.Fm).mp3", image: "Shiddat-Movie-Manan-Bhardwaj.jpg" }
    ];
