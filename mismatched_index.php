...
<button class="home-btn" onclick="window.location.href='sutar.php'">
  ...
  <div class="player-container">
    <!-- Album Art -->
    <div class="album-art">
      <img id="albumImage" src="Mismatched---Season-3-Taaruk-Raina.jpg" alt="Album Art">
    </div>
    <!-- Song Info -->
    <div class="song-info">
      <h2 id="songTitle">Do Din Ke Baad</h2>
      <p id="artist">Taaruk Raina</p>
    </div>
    ...
    <div class="bottom-controls">
      <div class="time-container">
        ...
        <span id="totalDuration">-3:20</span>
      </div>
  ...
  <audio id="audioPlayer" src="Do Din Ke Baad - (Raag.Fm).mp3"></audio>
  
  <script>
    let songs = [
      { title: "Do Din Ke Baad", artist: "Taaruk Raina", src: "Do Din Ke Baad - (Raag.Fm).mp3", image: "Mismatched---Season-3-Taaruk-Raina.jpg" },
      { title: "Gumshudah", artist: "Taaruk Raina", src: "Gumshudah.mp3", image: "Mismatched---Season-3-Taaruk-Raina.jpg" },
      { title: "Ishq Hai", artist: "Taaruk Raina", src: "Ishq-Hai.mp3", image: "Mismatched---Season-3-Taaruk-Raina.jpg" },
      { title: "Khaamiyan", artist: "Taaruk Raina", src: "Khaamiyan.mp3", image: "Mismatched---Season-3-Taaruk-Raina.jpg" },
      { title: "Pyaar Hai", artist: "Taaruk Raina", src: "Pyaar-Hai.mp3", image: "Mismatched---Season-3-Taaruk-Raina.jpg" },
      { title: "Rang Laago", artist: "Taaruk Raina", src: "Rang-Laago.mp3", image: "Mismatched---Season-3-Taaruk-Raina.jpg" },
      { title: "Sab Theek Hai", artist: "Taaruk Raina", src: "Sab-Theek-Hai.mp3", image: "Mismatched---Season-3-Taaruk-Raina.jpg" }
    ];
