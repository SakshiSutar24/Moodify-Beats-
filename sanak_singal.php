...
<head>
  ...
  />
  <link rel="stylesheet" href="sanak.php">
...
<body>
  ...
  <header class="album-header">
    <div class="album-top">
      ...
      <div class="album-info">
        ...
        <h1>Sanak</h1>
        <p>Various Artists • 2021 • 4 songs, ~16 min</p>

        <div class="btn-group">
          <button class="play-button" onclick="playMainSong('Sanak Title Track')">
            <i class="bi bi-play-fill"></i> Play
          </button>
          <a href="sanak.php" class="shiddat-link">
    ...
    <div class="movie-info">
      <h3>About Sanak</h3>
      <p>
        Sanak is a 2021 Indian Hindi-language action thriller film directed by Kanishk Varma.
        It stars Vidyut Jammwal, Rukmini Maitra, Neha Dhupia, and Chandan Roy Sanyal. The film's
        music is composed by various artists and features a mix of romantic and action-packed tracks.
      </p>
    </div>
  </header>
  ...
  <script>
    // सर्व गाणी
    const tracks = [
      { title: 'Ankhein Mili', duration: '4:05', src: 'Ankhein Mili - (Raag.Fm).mp3' },
      { title: 'O Yassra Dil Lagana', duration: '3:45', src: 'O Yaara Dil Lagana - (Raag.Fm).mp3' },
      { title: 'Suna Hai', duration: '4:20', src: 'Suna Hai - (Raag.Fm).mp3' },
      { title: 'Suna Hai (Female Version)', duration: '4:15', src: 'Suna Hai Female Version - (Raag.Fm).mp3' }
    ];
    ...
    function playMainSong(title) {
      const mainTrack = tracks.find(t => t.title === title);
      if (!mainTrack) return;
