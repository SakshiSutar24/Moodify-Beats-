...
<head>
  ...
  <title>Hum Bhi Akele - Now Playing</title>
...
<body>
  ...
  <div class="content">
    ...
    <div class="player-container">
      <!-- Album Art -->
      <div class="album-art">
        <img id="albumImage" src="Hum-Bhi-Akele-Tum-Bhi-Akele-Adil-Rasheed.jpg" alt="Album Art">
      </div>
      <!-- Song Info -->
      <div class="song-info">
        <h2 id="songTitle">Hai Nahin</h2>
        <p id="artist">Adil Rasheed</p>
      </div>
      ...
      <div class="bottom-controls">
        <div class="time-container">
          ...
          <span id="totalDuration">-3:50</span>
        </div>
  ...
  <script>
    let songs = [
      { title: "Hai Nahin", artist: "Adil Rasheed", src: "Hai Nahin - (Raag.Fm).mp3", image: "Hum-Bhi-Akele-Tum-Bhi-Akele-Adil-Rasheed.jpg" },
      { title: "Nazdeekiyan", artist: "Adil Rasheed", src: "Nazdeekiyan (Female) - (Raag.Fm).mp3", image: "Hum-Bhi-Akele-Tum-Bhi-Akele-Adil-Rasheed.jpg" }
    ];
    ...
    // Get the song title from the query parameter and play the song
    window.onload = function() {
      let songTitleParam = getQueryParam('song');
      if (songTitleParam) {
        let songIndex = songs.findIndex(song => song.title === songTitleParam);
        if (songIndex !== -1) {
