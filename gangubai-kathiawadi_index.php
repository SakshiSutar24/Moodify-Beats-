...
<head>
  ...
  <style>
    ...
    .controls button {
      background: #d10780; /* Professional blue color */
      border: none;
      color: #fff;
      width: 40px;
      height: 40px;
    ...
    .controls button:hover {
      transform: scale(1.1);
      box-shadow: 0 0 8px rgba(196, 18, 110, 0.7); /* Matching hover color */
    }
    ...
    .playlist-btn:hover {
      transform: scale(1.1);
      box-shadow: 0 0 8px rgba(214, 6, 141, 0.7); /* Matching hover color */
    }
    ...
    .home-btn:hover {
      transform: scale(1.1);
      box-shadow: 0 0 8px rgba(248, 10, 161, 0.7); /* Matching hover color */
    }
  </style>
</head>
<body>
  ...
  <div class="content">
    ...
    <div class="player-container">
      <!-- Album Art -->
      <div class="album-art">
        <img id="albumImage" src="Gangubai-Kathiawadi.jpg" alt="Album Art">
      </div>
      <!-- Song Info -->
      <div class="song-info">
        <h2 id="songTitle">Jab Saiyaan</h2>
        <p id="artist">Shreya Ghoshal</p>
      </div>
      ...
      <div class="bottom-controls">
        <div class="time-container">
          ...
          <span id="totalDuration">-4:10</span>
        </div>
    ...
    <audio id="audioPlayer" src="Jab Saiyaan - (Raag.Fm).mp3"></audio>
  </div>
  <script>
    let songs = [
      { title: "Jab Saiyaan", artist: "Shreya Ghoshal", src: "Jab Saiyaan - (Raag.Fm).mp3", image: "Gangubai-Kathiawadi.jpg" },
      { title: "Jhume Re Gori", artist: "Archana Gore, Tarannum Malik Jain", src: "Jhume Re Gori - (Raag.Fm).mp3", image: "Gangubai-Kathiawadi.jpg" },
      { title: "Meri Jaan", artist: "Neeti Mohan", src: "Meri Jaan - (Raag.Fm).mp3", image: "Gangubai-Kathiawadi.jpg" },
      { title: "Muskurahat", artist: "Shreya Ghoshal", src: "Muskurahat - (Raag.Fm).mp3", image: "Gangubai-Kathiawadi.jpg" },
      { title: "Shikayat", artist: "Archana Gore, Vishal Mishra", src: "Shikayat - (Raag.Fm).mp3", image: "Gangubai-Kathiawadi.jpg" }
    ];
    ...
    // Load song from localStorage if available
    window.addEventListener("load", function() {
      const currentSong = localStorage.getItem('currentSong');
      if (currentSong) {
        const songIndex = songs.findIndex(song => song.src === currentSong);
        if (songIndex !== -1) {
