...
<body>
  <div class="container">
    ...
    <div class="left-panel">
      <img src="Sonu-Nigam.jpg" alt="sonu" class="artist-photo">
      <div class="artist-info">
        <h1>Sonu Nigam</h1>
        <p class="verified"><i class="bi bi-patch-check-fill"></i> Verified Artist</p>
       <p>Sonu Nigam is one of India's most popular and versatile playback singers. </p> 
         <p><b>Born:</b>July 30, 1973\<p>
  ...
  <script>
const songs = [
  { name: "Tere_Bin", src: "Tere_Bin - (Raag.Fm).mp3" },
  { name: "Apni_Si_Lagti_Hai", src: "Apni_Si_Lagti_Hai - (Raag.Fm).mp3" },
  { name: "Deewane_Hoke_Hum", src: "Deewane_Hoke_Hum - (Raag.Fm).mp3" },
  { name: "Kuchh_Hua", src: "Kuchh_Hua - (Raag.Fm).mp3" },
  { name: "Main_Ki_Karaan", src: "Main_Ki_Karaan - (Raag.Fm).mp3" },
  { name: "Mere_Siva", src: "Mere_Siva - (Raag.Fm).mp3" },
  { name: "Meri_Duniya_Hai", src: "Meri_Duniya_Hai - (Raag.Fm).mp3" },
  { name: "Mujhe_Raat_Din_Bas", src: "Mujhe_Raat_Din_Bas - (Raag.Fm).mp3" },
  { name: "Sun_Zara", src: "Sun_Zara - (Raag.Fm).mp3" },
  { name: "Tera_Milna_Pal_Do_Pal_Ka", src: "Tera_Milna_Pal_Do_Pal_Ka - (Raag.Fm).mp3" }
];
