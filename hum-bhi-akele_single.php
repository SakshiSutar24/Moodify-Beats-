...
<head>
  ...
  <title>Hum Bhi Akele - Album Page</title>
...
<body>
  <button class="home-btn" onclick="window.location.href='music.php'">
  ...
  <header class="album-header">
    <div class="album-top">
      <img
        src="Hum-Bhi-Akele-Tum-Bhi-Akele-Adil-Rasheed.jpg"
        alt="Hum Bhi Akele Cover"
        class="album-cover"
      />
      <div class="album-info">
        <p class="album-type">ALBUM</p>
        <h1>Hum Bhi Akele</h1>
        <p>Adil Rasheed • 2021 • 2 songs, ~8 min</p>

        <div class="btn-group">
          <button class="play-button" onclick="playMainSong()">
            <i class="bi bi-play-fill"></i> Play
          </button>
          <a href="hum-bhi-akele.php" class="hum-bhi-akele-link">
            <i class="bi bi-music-note-list"></i>
            View Hum Bhi Akele Playlist
          </a>
        </div>
      </div>
    </div>
    ...
    <div class="movie-info">
      <h3>About Hum Bhi Akele</h3>
      <p>
        Hum Bhi Akele Tum Bhi Akele is a 2021 Indian Hindi-language romantic drama film directed by Harish Vyas.
        It stars Anshuman Jha and Zareen Khan. The film’s music is composed by Adil Rasheed and has become a hit
        among music lovers for its soulful tracks.
      </p>
    </div>
  </header>
  ...
  <script>
    // सर्व गाणी
    const tracks = [
      { title: 'Hai Nahin', duration: '3:50', src: 'Hai Nahin - (Raag.Fm).mp3' },
      { title: 'Nazdeekiyan', duration: '4:10', src: 'Nazdeekiyan (Female) - (Raag.Fm).mp3' }
    ];
    ...
    function playMainSong() {
      const mainTrack = tracks.find(t => t.title === 'Aare Hai Nahin');
      if (!mainTrack) return;
