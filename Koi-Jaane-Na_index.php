...
<button class="home-btn" onclick="window.location.href='sutar.php'">
  ...
  <div class="player-container">
    <!-- Album Art -->
    <div class="album-art">
      <img id="albumImage" src="Koi-Jaane-Na-Armaan-Malik.jpg" alt="Album Art">
    </div>
    <!-- Song Info -->
    <div class="song-info">
      <h2 id="songTitle">Koi Jaane Na</h2>
      <p id="artist">Armaan Malik</p>
    </div>
    ...
    <div class="bottom-controls">
      <div class="time-container">
        ...
        <span id="totalDuration">-4:05</span>
      </div>
  ...
  <audio id="audioPlayer" src="Har Funn Maula - (Raag.Fm).mp3"></audio>
  
  <script>
    let songs =[
      { title: 'Har Funn Maula', duration: '3:20', src: 'Har Funn Maula - (Raag.Fm).mp3', image: 'Koi-Jaane-Na-Armaan-Malik.jpg', artist: 'Vishal Dadlani, Zara Khan' },
      { title: 'Ishq Karo Dil Se', duration: '3:35', src: 'Ishq Karo Dil Se - (Raag.Fm).mp3', image: 'Koi-Jaane-Na-Armaan-Malik.jpg', artist: 'Jubin Nautiyal, Tulsi Kumar' },
      { title: 'Jaane De', duration: '4:00', src: 'Jaane De - (Raag.Fm).mp3', image: 'Koi-Jaane-Na-Armaan-Malik.jpg', artist: 'B Praak' },
      { title: 'Koi Jaane Na', duration: '4:05', src: 'Koi Jaane Na (Title Track) - (Raag.Fm).mp3', image: 'Koi-Jaane-Na-Armaan-Malik.jpg', artist: 'Armaan Malik' },
      { title: 'Rabb Manneya', duration: '3:50', src: 'Rabb Manneya - (Raag.Fm).mp3', image: 'Koi-Jaane-Na-Armaan-Malik.jpg', artist: 'Rochak Kohli, Shashwat Singh' }
    ];
    
    let currentSongIndex = 3; // Set the initial song index to 'Koi Jaane Na'
