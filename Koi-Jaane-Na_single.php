...
<head>
  ...
  <title>Koi Jaane Na - Album Page</title>
  ...
  />
  <link rel="stylesheet" href="Koi-Jaane-Na.php">
...
<body>
  ...
  <header class="album-header">
    <div class="album-top">
      <img
        src="Koi-Jaane-Na-Armaan-Malik.jpg"
        alt="Koi-Jaane-Na Cover"
        class="album-cover"
      />
      <div class="album-info">
        <p class="album-type">ALBUM</p>
        <h1>Koi Jaane Na</h1>
        <p>Armaan Malik • 2021 • 5 songs, ~19 min</p>
        ...
        <div class="btn-group">
          ...
          <a href="Koi-Jaane-Na.php" class="Koi-Jaane-Na-link">
            <i class="bi bi-music-note-list"></i>
            View Koi Jaane Na Playlist
          </a>
        </div>
      </div>
    </div>
    ...
    <div class="movie-info">
      <h3>About Koi Jaane Na</h3>
      <p>
        Koi Jaane Na is a 2021 Indian Hindi-language psychological thriller film directed by Amin Hajee.
        It stars Kunal Kapoor and Amyra Dastur in the lead roles. The film's music is composed by Tanishk Bagchi,
        Rochak Kohli, and Amaal Mallik, and has become popular for its captivating tracks.
      </p>
    </div>
  </header>
  ...
  <script>
    // All tracks
    const tracks = [
      { title: 'Har Funn Maula', duration: '3:20', src: 'Har Funn Maula - (Raag.Fm).mp3' },
      { title: 'Ishq Karo Dil Se', duration: '3:35', src: 'Ishq Karo Dil Se - (Raag.Fm).mp3' },
      { title: 'Jaane De', duration: '4:00', src: 'Jaane De - (Raag.Fm).mp3' },
      { title: 'Koi Jaane Na', duration: '4:05', src: 'Koi Jaane Na (Title Track) - (Raag.Fm).mp3' },
      { title: 'Rabb Manneya', duration: '3:50', src: 'Rabb Manneya - (Raag.Fm).mp3' }
    ];
    ...
    function playMainSong() {
      const mainTrack = tracks.find(t => t.title === 'Koi Jaane Na');
      if (!mainTrack) return;
