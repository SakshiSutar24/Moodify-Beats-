...
<head>
  ...
  />
  <link rel="stylesheet" href="saina.php">
...
<body>
  ...
  <header class="album-header">
    <div class="album-top">
      ...
      <div class="album-info">
        ...
        <h1>Saina</h1>
        <p>Amaal Mallik • 2021 • 6 songs, ~23 min</p>

        <div class="btn-group">
          <button class="play-button" onclick="playMainSong()">
            <i class="bi bi-play-fill"></i> Play
          </button>
          <a href="saina.php" class="saina-link">
    ...
    <div class="movie-info">
      <h3>About Saina</h3>
      <p>
        Saina is a 2021 Indian Hindi-language biographical sports film directed by Amole Gupte. 
        It stars Parineeti Chopra as Saina Nehwal, the professional badminton player. The film's music is 
        composed by Amaal Mallik and has been appreciated for its inspiring tracks.
      </p>
    </div>
  </header>
  ...
  <script>
    // सर्व गाणी
    const tracks = [
      { title: 'Parinda', duration: '3:07', src: 'Parinda - (Raag.Fm).mp3' },
      { title: 'Main Hoon Na Tere Saath', duration: '3:30', src: 'Main Hoon Na Tere Saath - (Raag.Fm).mp3' },
      { title: 'Chal Wahin Chalein', duration: '4:05', src: 'Chal Wahin Chalein - (Raag.Fm).mp3' },
      { title: 'A Mothers Love', duration: '3:45', src: 'A Mothers Love - (Raag.Fm).mp3' },
      { title: 'The Curse of a Champion', duration: '4:10', src: 'The Curse of a Champion - (Raag.Fm).mp3' },
      { title: 'The Staircase of Life', duration: '3:55', src: 'The Staircase of Life - (Raag.Fm).mp3' }
    ];
    ...
    function playMainSong() {
      const mainTrack = tracks.find(t => t.title === 'Saina Title Track');
      if (!mainTrack) return;
